...
# OAuth environment variables from addon config options
export TRILIUM_OAUTH_BASE_URL="${OAUTH_BASE_URL}"
export TRILIUM_OAUTH_CLIENT_ID="${OAUTH_CLIENT_ID}"
export TRILIUM_OAUTH_CLIENT_SECRET="${OAUTH_CLIENT_SECRET}"
export TRILIUM_OAUTH_ISSUER_BASE_URL="${OAUTH_ISSUER_BASE_URL}"
